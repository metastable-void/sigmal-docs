...
At its logical core, Sigmal is based on the **minimal Calculus of Inductive Constructions (CIC).** which is an extension of Calculus of Constructions (CoC).
The core type system is a stratified, total, dependent λ-calculus with inductive families, in which terms and types inhabit a unified hierarchy of universes.
...
- Inductive types may be indexed by values (inductive families).
...
* Based on a minimal Calculus of Inductive Constructions
